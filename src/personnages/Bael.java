...
public class Bael extends Personnage {
	...
	public Bael(Joueur owner) {
		...
		this.actions.add(new Attaque(this, 2, "Rayon Noir", "Portée de l'Attaque : 16 cases, Attaque +1 / Dégâts +2", 1, 1, 2, 0, 16));
		this.actions.add(new EffetInfligeAttitude(this, 2, "La Marque d'Erebus", "Lancez Bloqué Niv. 2 sur une unité ennemie dans la Zone de Contrôle de Bael. Effet 16.", Bloque.class, 2, 16, 0));
		this.actions.add(new EffetInfligeAttitude(this, 2, "La Marque de Noah", "Lancez Berserk Niv. 2 sur une unité amie dans la Zone de Contrôle de Bael. Effet 16.", Berserk.class, 2, 16, 0));
		this.actions.add(new EffetInfligeAttitude(this, 4, "La Marque de Jedah", "Lancez Paralysé Niv. 2 sur une unité ennemie dans la Zone de Contrôle de Bael. Effet 16.", Paralyse.class, 2, 16, 0));
